...
import { createPost, deletePost, updatePost, likePost, dislikePost, getPostWithComments, getPost } from "../controllers/post.js"
import asyncHandler from "../utils/asyncHandler.js"

const postRouter: express.Router = express.Router()

postRouter.get("/:postId", authenticationMiddleware, asyncHandler(getPost))
